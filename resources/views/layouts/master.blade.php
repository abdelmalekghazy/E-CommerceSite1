            ...
            <div class="row">
                <div class="col-lg-12 col-sm-12 text-center">
                    <div class="main-menu-wrap">
                        ...
                        <div class="site-logo">
                            <a href="/">
                                <img src="{{ asset('assets/img/logo.png') }}" alt="" style="height:50px;width:100px">
                            </a>
                        </div>
                        <!-- logo -->
                        ...
                        <nav class="main-menu">
                            <ul>
                                ...
                                <li><a href="/reviews">Customer opinion</a></li>
					...
					<div class="col-md-12 col-lg-7 offset-lg-1 offset-xl-0">
						<div class="hero-text">
							<div class="hero-text-tablecell">
								<p class="subtitle">New & Orginal</p>
								<h1>guaranteed products</h1>
								<div class="hero-btns">
									<a href="/products" class="boxed-btn">Fruit Collection</a>
									<a href="/reviews" class="bordered-btn">Contact Us</a>
								</div>
							</div>
						</div>
					</div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="footer-box about-widget">
                        ...
                        <p>My name is Abdulmelik Gazi, the developer of this page.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-box pages">
                        <h2 class="widget-title">admin panel</h2>
                        <ul>
